...
import com.bitcoin.tracker.walletx.activity.graphs.GraphSpendingByCategoryActivity;
import com.bitcoin.tracker.walletx.activity.walletxSummary.module.WalletxSummaryModuleSpendingBreakdownByCategory;
 ...
 */
public abstract class WalletxSummaryAbstractActivity extends ActionBarActivity implements
        WalletxSummaryModuleTxs.OnFragmentInteractionListener,
        WalletxSummaryModuleSpendingBreakdownByCategory.OnFragmentInteractionListener,
        SyncableInterface {
    ...
    protected WalletxSummaryModuleSpendingBreakdownByCategory mSpendingSummaryModule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpendingSummaryModule = (WalletxSummaryModuleSpendingBreakdownByCategory) getFragmentManager().findFragmentById(R.id.moduleSpendingBreakdown);
    ...
    public void onFragmentInteraction(SupportedSummaryType type){
        ...
        switch (type) {
            ...
            case SPENDING_BY_CATEGORY:
                intent = new Intent( this, GraphSpendingByCategoryActivity.class );
                intent.putExtra("group_name", getSupportActionBar().getTitle().toString());
                // See above comment
