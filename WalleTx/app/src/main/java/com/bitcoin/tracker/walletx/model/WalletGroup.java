...
public class WalletGroup extends Model {
    ...
    private void setAsDefault(boolean isDefault) {
        ...
        if (isDefault) {
            ...
            WalletGroup currentDefault = WalletGroup.getDefault();
     ...
     */
    public static void swap(WalletGroup wg1, WalletGroup wg2) {
     ...
     */
    public static void deleteGroup(WalletGroup delete) {
        ...
        List<WalletGroup> groups = WalletGroup.getAllWithDisplayOrderGreaterThan(delete.getDisplayOrder());
